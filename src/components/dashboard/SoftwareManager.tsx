...
export default function SoftwareManager() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-3">
        ...
        <p className="text-white/40 text-sm animate-pulse">Loading portal...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white/[0.01] border border-white/5 rounded-[2.5rem] p-8 md:p-10 backdrop-blur-2xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[10px] text-white/20 mt-1 font-black uppercase tracking-widest">
              Private Access & Multi-System Monitoring
            </p>
          </div>
          
          <div className="flex items-center gap-1 bg-white/[0.02] border border-white/5 rounded-2xl p-1.5 backdrop-blur-xl shrink-0">
             <button
          ...
          <div className="space-y-4">
            ...
            {categories.length === 0 && (
              <div className="text-center py-20 bg-white/[0.01] rounded-[2rem] border border-white/[0.04]">
                ...
                <p className="text-white/20 text-xs mt-1">Please come back later.</p>
              </div>
            )}
          </div>
        </div>
