...
const navItems: NavItem[] = [
  ...
  { href: '/dashboard/bulk', label: 'Bulk', icon: ShoppingCart, requiredRole: ['reseller', 'admin', 'owner'] },
  { href: '/dashboard/inbox', label: 'Inbox', icon: Inbox },
  { href: '/dashboard/bio', label: 'Bio', icon: User, requiredRole: ['owner', 'admin'] },
  { href: '/dashboard/analytics', label: 'Stats', icon: BarChart3, requiredRole: ['owner', 'admin'] },
  { href: '/dashboard/admin', label: 'Admin', icon: Shield, requiredRole: ['admin', 'owner'] },
  { href: '/dashboard/settings', label: 'Settings', icon: Settings, requiredRole: ['owner'] },
