          ...
          <div className="relative flex flex-col items-center text-center p-10 rounded-[2rem] bg-black/40 border border-white/10 backdrop-blur-xl">
            {error ? (
              ...
              <div className="space-y-8 w-full">
                <div className="h-20 w-20 rounded-2xl bg-purple-500/10 flex items-center justify-center mx-auto text-purple-400 group-hover:scale-110 transition-transform duration-500">
